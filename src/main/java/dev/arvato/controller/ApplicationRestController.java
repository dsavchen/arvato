...
public class ApplicationRestController {
    ...
    public ResponseEntity<ParkingInvoice> getInvoice(@PathVariable("id") long id)  {
        Customer customer = customerService.findById(id);
        if (customer == null) {
            return new ResponseEntity<ParkingInvoice>(HttpStatus.NOT_FOUND);
        }
    	ParkingInvoice ret = parkingService.getInvoice(customer);
        return new ResponseEntity<ParkingInvoice>(ret, HttpStatus.OK);
    }
