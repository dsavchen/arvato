...
<html>
  ...
  <body ng-app="myApp" class="ng-cloak">
      <p><a href="/ArvatoApp/">Parking</a></p>
                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                <select ng-model="ctrl.customer.group" ng-options="item.name for item in ctrl.groups" id="group" class="form-control input-sm" required></select>
                              </div>
                          </div>
                      </div>
